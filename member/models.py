...
class Member(models.Model):
    ...
    res_area = models.ForeignKey(Society, on_delete=models.SET_NULL, null=True, blank=True)
    res_city = models.ForeignKey(City, on_delete=models.SET_NULL, null=True, blank=True)
    res_state = models.ForeignKey(State, on_delete=models.SET_NULL, null=True, blank=True)
    res_country = models.ForeignKey(Country, on_delete=models.SET_NULL, null=True, blank=True)
